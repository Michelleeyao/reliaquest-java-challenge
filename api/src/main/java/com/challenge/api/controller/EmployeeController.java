...
//REST controller for handling all employee-related API endpoints.
@RestController
@RequestMapping("/api/v1/employee") //sets base path
public class EmployeeController {
    ...
    public ResponseEntity<Employee> createEmployee(@RequestBody CreateEmployeeRequest request) {
        // Create an internal EmployeeModel and map data from the DTO
